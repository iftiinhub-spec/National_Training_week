  ...
  return (
    <div className="flex min-h-[72vh] items-center justify-center bg-white px-4 py-16 sm:px-6 lg:px-8">
      <div className="w-full max-w-xl text-center">
        ...
        <p className="mt-8 text-sm font-black text-[#1da156]">Error 404</p>
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link
            to="/"
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#15803d] px-5 py-3 text-sm font-bold text-white shadow-md transition-colors hover:bg-black sm:w-auto"
          >
