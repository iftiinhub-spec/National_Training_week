    ...
    <section className="bg-white py-16 sm:py-20">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-8 lg:grid-cols-[minmax(16rem,0.72fr)_minmax(0,1.28fr)] lg:gap-16">
        <div className="lg:pt-5">
          <p className="text-xs font-bold uppercase tracking-[.16em] text-[#1a6b3c]">Support and guidance</p>
          <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-950">Answers when you need them</h2>
