...
const QRCheckIn = () => {
  ...
  return <div className="flex min-h-[75vh] items-center justify-center bg-slate-50 px-4 py-16">
    <div className="w-full max-w-xl overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl">
      <div className="bg-[#1a6b3c] px-6 py-8 text-center text-white"><QrCodeIcon className="mx-auto h-11 w-11" /><p className="mt-4 text-xs font-bold uppercase tracking-[.16em] text-white/70">Live session attendance</p><h1 className="mt-2 text-2xl font-bold">QR Check-In</h1></div>
