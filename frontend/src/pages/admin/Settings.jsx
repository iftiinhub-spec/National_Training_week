...
import { EnvelopeIcon, EyeIcon, EyeSlashIcon, GlobeAltIcon, PencilIcon, ShieldCheckIcon, XMarkIcon } from '@heroicons/react/24/outline';
...
const initial = { organizerName: '', contactEmail: '', replyToEmail: '', location: '', facebookUrl: '', emailSenderName: '', smtpUser: '', smtpPassword: '', hasSmtpPassword: false };
